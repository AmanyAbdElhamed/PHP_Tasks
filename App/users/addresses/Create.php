...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(count($errors) > 0){
      ...
      $custID=1;
      //$_SESSION['user']['id'];
       $sql = "insert into address_details (address,city,state,zipecode,country,customer_id) 
       values ('$address','$city','$state','$zipecode','$country',$custID)"; 
       $op  = doQuery($sql);
    ...
    <div class="row">
      ...
      <div class="alert alert-info alert-dismissable">
          ...
          <i class="fa fa-coffee"></i>
           This is an <strong>.alert</strong>. <?php PrintMessages('Address / Create');?>
        </div>
        <h3>Personal info</h3>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" placeholder="Address Line 1" class="form-control" name="address">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" placeholder="Zip Code" class="form-control" name="zipecode">
            </div>
          </div>
