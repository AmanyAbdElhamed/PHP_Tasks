...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://localhost/group12/App\users\resources\css\index.css">
        ...
        <div class="col-md-4">
            <div class="card user-card">
                ...
                <div class="card-block">
                    ...
                    <hr>
                    <p class="text-muted m-t-15"><i class="fa fa-shopping-cart" aria-hidden="true"></i></p>
